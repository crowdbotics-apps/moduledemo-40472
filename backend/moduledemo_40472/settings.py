"""
Django settings for moduledemo_40472 project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites', "protfilio"
]
LOCAL_APPS = [
    'home',
...
ROOT_URLCONF = 'moduledemo_40472.urls'
...
WSGI_APPLICATION = 'moduledemo_40472.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "moduledemo_40472 API",
    "DESCRIPTION": "API documentation for moduledemo_40472 App",
    "VERSION": "v1",
}
